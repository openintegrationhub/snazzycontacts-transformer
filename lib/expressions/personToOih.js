...
module.exports.getExpression = msg => {
  ...
  console.log('HERE: ', msg.body.data.payload);
  const expression = {
    meta: {
      domainId: '',
      schemaUri: ''
    ...
    data: {
      firstName: msg.body.data.payload.firstName,
      lastName: msg.body.data.payload.lastName
    }
  ...
  console.log('EXPRESION TO OIH: ', expression);
  return expression;
};
