...
module.exports.getExpression = function(msg) {
  const expression = {
    ...
    "oihApplicationRecords": [{
      ...
      "created": msg.body.created ? msg.body.created : "",
      "lastModified": msg.body.last_update
    }],
    "title": msg.body.title ? msg.body.title : "",
    "salutation": msg.body.salutation ? msg.body.salutation : "",
    "firstName": (msg.body.firstname === null) ? "" : msg.body.firstName,
    "middleName": msg.body.middleName ? msg.body.middleName : "",
    "lastName": msg.body.name ? msg.body.lastName : "",
    "gender": msg.body.gender ? msg.body.gender : "",
    "birthday": msg.body.date_of_birth ? msg.body.date_of_birth : "",
    "notes": msg.body.notes ? msg.body.notes : "",
    "displayName": msg.body.displayName ? msg.body.displayName : "",
    "language": msg.body.language ? msg.body.language : "",
    "nickname": msg.body.nickname ? msg.body.nickname : "",
    "jobTitle": msg.body.position ? msg.body.position : "",
    "photo": msg.body.picture_url ? msg.body.picture_url : "",
    "anniversary": "",
    "address": [{
