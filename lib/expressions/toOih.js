...
module.exports.getExpression = function(msg) {
  const expression = {
    ...
    "title": (msg.body.title === null) ? 'null' : 'not null',
    "salutation": msg.body.salutation,
    "firstName": msg.body.firstname,
    "middleName": msg.body.middleName ? msg.body.middleName : "here",
  ...
  console.log(`TITLE: ${expression.title}`);
  console.log(`MIDDLE NAME: ${expression.middleName}`);
  console.log(`BIRTHDAY: ${expression.birthday}`);
  return expression;
}
